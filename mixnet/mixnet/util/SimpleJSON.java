...
public class SimpleJSON {
    ...
    /**
     * Reads a map from the head
     * @return a Treemap
     */
    public static TreeMap<String,String> readMap(Head head)
        throws SimpleJSONException
    {
        ...
        if (head.end() || !head.equals('{'))
        {
            throw new SimpleJSONException("Missing starting '{' char");
        }
        head.inc();
        head.skipWhitespace();
        readPair(head,map);
    ...
    public static TreeMap<String,String> readMap(String mapString)
    throws SimpleJSONException {
    ...
    public static ArrayList<TreeMap<String,String>>
        readMaps(String mapString)
    throws SimpleJSONException {
        Head head = new Head(mapString);

        ArrayList<TreeMap<String,String>> maps =
