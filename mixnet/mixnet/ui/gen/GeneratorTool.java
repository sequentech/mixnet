 ...
 * <code>mixnet.arithm</code> and <code>mixnet.crypto</code>
 ...
 * mixnet.crypto.PRGElGamal} is {@link
 * mixnet.crypto.PRGElGamalGen}.
 *
...
public class GeneratorTool {
    ...
    static {
        clsnames.add("mixnet.crypto.PRG");
        clsnames.add("mixnet.arithm.LargeInteger");
    }
...
" -gen ModPGroup -fixed 1024       # Squares modulo safe prime.";
    ...
    throws GenException {
        ...
        throw new GenException("Error! Can not find class implementing "
                               + "the interface "
                               + "mixnet.ui.gen.Generator which is "
                               + "named " + name + "!");
    }
