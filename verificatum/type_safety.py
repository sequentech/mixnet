...
#    verificatum.eio.Marshalizer.java
#    verificatum.eio.HexConverter.java
#
...
grepOutput = os.popen('grep -R "Marshalizer.unmarshal" verificatum | grep -v "TYPE" | grep ".java:"').read()
um = uniqueMatches("unmarshal", grepOutput)
methods = gen_unmarshal_TYPE_methods(um)

grepOutput = os.popen('grep -R "Marshalizer.unmarshalHex" verificatum | grep -v "TYPE" | grep ".java:"').read()
um = uniqueMatches("unmarshalHex", grepOutput)
methodsHex = gen_unmarshalHex_TYPE_methods(um)

f = open("verificatum/eio/Marshalizer.gen")
content = f.read()
f.close()

f = open("verificatum/eio/Marshalizer.java", "w")
