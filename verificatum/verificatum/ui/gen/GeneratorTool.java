 ...
 * <code>verificatum.arithm</code> and <code>verificatum.crypto</code>
 ...
 * verificatum.crypto.PRGElGamal} is {@link
 * verificatum.crypto.PRGElGamalGen}.
 *
...
public class GeneratorTool {
    ...
    static {
        clsnames.add("verificatum.crypto.PRG");
        clsnames.add("verificatum.arithm.LargeInteger");
    }
...
" -gen ModPGroup -fixed 1024       # Squares modulo safe prime.";
    ...
    throws GenException {
        ...
        throw new GenException("Error! Can not find class implementing "
                               + "the interface "
                               + "verificatum.ui.gen.Generator which is "
                               + "named " + name + "!");
    }
