...
import java.math.*;
public class MillerRabinTrial {

    public static boolean trial(BigInteger n) {
        ...
        r = n.mod(BigInteger.valueOf(3*5*7*11*13*17*19*23*29L)).longValue();
        if (r % 3L == 0
            || r % 5L == 0
            || r % 7L == 0
            || r % 11L == 0
    ...
    public static boolean safeTrial(BigInteger n) {
    ...
    BigInteger m = n.subtract(BigInteger.ONE).shiftRight(1);
        ...
        r = m.mod(BigInteger.valueOf(3*5*7*11*13*17*19*23*29L)).longValue();
        if (r % 3L == 0
            || r % 5L == 0
            || r % 7L == 0
            || r % 11L == 0
