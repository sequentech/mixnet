...
public abstract class PGroupElementArray
     ...
     * belongs.
     */
    protected PGroupElementArray(PGroup pGroup) {
        this.pGroup = pGroup;
    }
    ...
    /**
     * Computes the element-wise power of the elements in this
     * instance to the powers in the input array.
     *
     * @param exponentsArray Exponents to use when taking powers.
     * @return Element-wise power of the elements in this instance to
     * the powers in the input array.
     */
   ...
   /**
     ...
     * the given power.
     */
    public PGroupElementArray expMul(PRingElement exponent,
                                     PGroupElementArray factorsArray) {
        PGroupElementArray tmp = exp(exponent);
        PGroupElementArray res = tmp.mul(factorsArray);
        tmp.free();
        return res;
    }
     ...
     * the given power.
     */
    public PGroupElementArray expMul(PRingElementArray exponentsArray,
                                     PGroupElementArray factorsArray) {
        PGroupElementArray tmp = exp(exponentsArray);
        PGroupElementArray res = tmp.mul(factorsArray);
        tmp.free();
        return res;
    }
