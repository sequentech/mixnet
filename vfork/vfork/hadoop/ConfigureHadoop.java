...
package vfork.hadoop;

import vfork.eio.ByteTree;
import vfork.eio.GenericIO;
import vfork.eio.IOWrapper;
import vfork.arithm.LargeIntegerArray;
import vfork.arithm.LargeIntegerArrayWrapper;
import vfork.arithm.HugeArray;
...
public class ConfigureHadoop {
    ...
    public static void configure() {
        ...
        try {
            ...
            String className =
                "org.vfork.hadoop.LargeIntegerArrayHadoopWrapper";
            ...
            String randomPath = "/vfork-" + UUID.randomUUID().toString();
            ...
            Class<?> cls2 =
                Class.forName("org.vfork.hadoop.HadoopIOWrapper");
