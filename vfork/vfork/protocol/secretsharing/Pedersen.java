...
public class Pedersen extends Protocol implements PGroupAssociated {
    ...
    /**
     * Is set to true when the secret shared in this instance can be
     * recovered.
     */
    ...
    public Pedersen(String sid,
        ...
        pedersenBasic =
            new PedersenBasic(k, threshold, j, l, hom, randomSource, statDist);
        this.l = l;
        this.pkeys = pkeys;
        this.skey = skey;
     ...
     * state from file and returns true and otherwise it
     * returns false.
     *
     * @param log Logging context.
    ...
    /**
     * Receives a secret share. Returns true or
     * false depending on if the sharing was accepting or not.
     *
     * @param log Logging context.
    ...
    public void setTrivial(Log log) {
        ...
        pedersenBasic =
            new PedersenBasic(k, threshold, j, l, pedersenBasic.getHom(),
                              statDist);
        trivial = true;
