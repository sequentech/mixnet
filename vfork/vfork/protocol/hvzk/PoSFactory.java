...
public class PoSFactory {
    ...
    /**
     * Creates a factory that constructs instances of {@link PoS}.
     *
     ...
     */
    public PoSFactory(Challenger challenger,
                      PRG prg,
     ...
     */
    public PoS newPoS(String sid, Protocol protocol) {
        return new PoSTW(sid,
                         protocol,
                         challenger,
                         prg,
                         challengeBitLength,
