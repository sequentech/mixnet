...
#    vfork.eio.Marshalizer.java
#    vfork.eio.HexConverter.java
#
...
grepOutput = os.popen('grep -R "Marshalizer.unmarshal" vfork | grep -v "TYPE" | grep ".java:"').read()
um = uniqueMatches("unmarshal", grepOutput)
methods = gen_unmarshal_TYPE_methods(um)

grepOutput = os.popen('grep -R "Marshalizer.unmarshalHex" vfork | grep -v "TYPE" | grep ".java:"').read()
um = uniqueMatches("unmarshalHex", grepOutput)
methodsHex = gen_unmarshalHex_TYPE_methods(um)

f = open("vfork/eio/Marshalizer.gen")
content = f.read()
f.close()

f = open("vfork/eio/Marshalizer.java", "w")
