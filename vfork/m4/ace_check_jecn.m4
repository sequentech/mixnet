...
then
   ...
   echo "no"
   AC_MSG_ERROR([$ace_res Please make sure that JECN is installed (found at www.vfork.com) and that your \$CLASSPATH points to the proper location. You may use the option --disable-check_jecn to ignore this error if you know that you will install this package later.])
fi
])
])
